...
function setendpic()
{
	...
	$('#'+temp).css("background-image","url("+level+"/_0"+(picnum-2)*(picnum-2)+".jpg)");
}
	...
	for(var i=1;i<picnum-1;i++)
	  {
			...
			if(id>picnum*i+1&&id<picnum*(i+1))
		{
			...
			$('#'+id).css("background-image","url("+level+"/_0"+pic+".jpg)");
	...
	for(var i=1;i<picnum-1;i++)
	  {
		for(var id=1;id<picnum*picnum;id++)
		{
			if(id>picnum*i+1&&id<picnum*(i+1))
		{
			var temp=$('#'+id).css("background-image","url("+level+"/_0"+a_num[K]+".jpg)");
			k++;
		}
		}
	  }
...
{
	$('.pic').css("background-image","url(level1/main.jpg)");
